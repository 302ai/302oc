 ...
 * 加载 OpenClaw 配置
 */
export function loadOpenClawSettings() {
 ...
 * 保存 OpenClaw 配置
 */
export function saveOpenClawSettings(settings) {
    try {
        // 确保目录存在
 ...
 * 备份 OpenClaw 配置
 */
export function backupOpenClawSettings() {
    if (!existsSync(SETTINGS_FILE)) {
        return null;
    }
    try {
 ...
 * 获取 OpenClaw 配置路径
 */
export function getOpenClawSettingsPath() {
