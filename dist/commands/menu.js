...
async function configureApiKey(config) {
...
async function configureEndpoint(config) {
    console.log(chalk.cyan.bold('\n════════════════════════════════════════'));
...
async function configureLanguage(config) {
    console.log(chalk.cyan.bold('\n════════════════════════════════════════'));
...
async function applyAndExit(config) {
    if (!config.apiKey) {
