...
export async function configManager(action: string): Promise<void> {
 ...
 * 列出所有配置
 */
function listConfigs(config: any): void {
  ...
  Object.entries(config.profiles).forEach(([id, profile]: [string, any]) => {
 ...
 * 添加新配置
 */
async function addConfig(config: any): Promise<void> {
  console.log(chalk.cyan.bold('\n════════════════════════════════════════'));
 ...
 * 删除配置
 */
async function removeConfig(config: any): Promise<void> {
  console.log(chalk.cyan.bold('\n════════════════════════════════════════'));
  ...
  const choices = Object.entries(config.profiles).map(([id, profile]: [string, any]) => {
    const isCurrent = id === config.currentProfile;
